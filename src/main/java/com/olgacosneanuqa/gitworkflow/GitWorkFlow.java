package com.olgacosneanuqa.gitworkflow;

public class GitWorkFlow {

    public static void main(String[] args) {

        String step1 = "Open IntelliJ IDEA and navigate to the main/master branch - git checkout master";
        ...
        String step3 = "Execute the command - git pull - that will download the changes form origin/master to local master branch";
        String step4 = "Create a new branch and move to it - git checkout -b task_1 - it will redirect us to the task_1 branch";

        // As result, there are 2 branches on the local memory: master & task_1, and on the cloud memory we have only one branch: origin/master
